...
public class ParameterizedTests {
    ...
    /* 수업목표.
        junit-jupiter-params 모듈을 이용하여 파라미터를 이용한 테스트를 작성할 수 있습니다. */

    /* 사전조건.
    *   build.gradle 파일에 dependency에 junit-jupiter-params 의존성을 추가해야 사용할 수 있습니다.
    *  */

    /* 필기.
    *   테스트 시 여러 값들을 이용하여 검증을 해야 하는 경우 모든 경우의 수 만큼 테스트 메소드를 작성해야 합니다.
