...
객체지향 5원칙 중 '의존성 역전' 원칙에 해당. 특정 DBMS의 종속성을 없애기 위해. 데이터베이스 간의 의존성을 없앤다.

![image](https://github.com/Subak-Uncle/Subak-Uncle/assets/115992753/9f079eee-8c11-470a-80a3-dd49a148b77d)
...
- Graphic 기반 Interface
- Command 기반 Interface



~~~mysql
/* 필기. 권한 부여를 위한 계정 생성, @'%'가 붙어야 외부 pc에서 접근 가능*/
