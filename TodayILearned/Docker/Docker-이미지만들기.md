...
![docker-createproject1.png](../images/Docker-이미지만들기/docker-createproject1.png)

![docker-createproject2.png](../images/Docker-이미지만들기/docker-createproject2.png)
...
![docker-dockerfile.png](../images/Docker-이미지만들기/docker-dockerfile.png)
...
remote에서 사용할 경우, 
docker build -t {사용자 아이디}/{앱 이름} {Dockerfile 위치}
```

- Dockerfile 빌드 진행

![docker-builddockerfile.png](../images/Docker-이미지만들기/docker-builddockerfile.png)
